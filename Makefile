SRCFILES=main.cpp token.cpp lexer.cpp parser.cpp irCodegenContext.cpp identifier.cpp symbolTable.cpp astType.cpp irDebug.cpp message.cpp parsec.cpp ast.cpp validate.cpp
